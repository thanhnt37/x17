        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent1">
            ...
            <section id="search-box-desktop">
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <input id="search-input-desktop" class="form-control mr-sm-2" type="text"
                           placeholder="Tìm kiếm gì nào" aria-label="Search">
                </form>
            </section>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <section>
                    ...
                    <p>Đăng ký ngay bây giờ để nhận được thông báo về những bài viết mới nhất của mình. Còn rất nhiều
                        chủ đề và bài viết hay sẽ được cập nhật trong thời gian tới.</p>
                </section>
            </div>
            <div class="col-lg-5">
