...
class RepositoryBindServiceProvider extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton(
            \App\Repositories\SeriesRepositoryInterface::class,
            \App\Repositories\Eloquent\SeriesRepository::class
        );

        $this->app->singleton(
            \App\Repositories\SearchRepositoryInterface::class,
            \App\Repositories\Eloquent\SearchRepository::class
        );

        $this->app->singleton(
            \App\Repositories\ArticleImageRepositoryInterface::class,
            \App\Repositories\Eloquent\ArticleImageRepository::class
        );
